...
def objective_graph_transformer(hyper_par):
    ...
    early_stop = False
    fold_valid_node_loss, fold_valid_pairwise_loss = 0, 0
    for fold in range(10):
        ...
        fold_valid_node_loss += valid_node_loss[min_index]
        fold_valid_pairwise_loss += valid_pairwise_loss[min_index]
    
    penalty = 0
    if early_stop:
        penalty = 10

    loss = fold_valid_node_loss / 10 + fold_valid_pairwise_loss / 10
