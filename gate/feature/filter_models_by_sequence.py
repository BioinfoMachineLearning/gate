...
def filter_models(targetname, fasta_path, outdir, input_model_dir):
    ...
    for model in sorted(os.listdir(input_model_dir)):
        ...
        process_list.append([sequence_id_map, input_model_dir + '/' + model, workdir, outdir + '/' + model])
...
if __name__ == '__main__':
    ...
    for fastafile in sorted(os.listdir(args.fastadir)):
        ...
        filter_models(targetname, args.fastadir + '/' + fastafile, outdir, args.modeldir + '/' + targetname)
