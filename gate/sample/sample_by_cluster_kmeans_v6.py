...
def sample_models_by_kmeans(usaligndir, mmaligndir, qsscoredir, interfacedir, sample_number_per_target, outdir_base):
    ...
    for pairwise_file in os.listdir(usaligndir):
        ...
        pairwise_dockq_wave_graph = pd.read_csv(interfacedir + '/' + targetname + '_dockq_wave.csv', index_col=[0])
        pairwise_dockq_ave_graph = pd.read_csv(interfacedir + '/' + targetname + '_dockq_ave.csv', index_col=[0])
...
if __name__ == '__main__':
    ...
    for sample_number_per_target in sample_numbers_per_target:
        ...
        makedir_if_not_exists(outdir)
        sample_models_by_kmeans(args.usaligndir, args.mmaligndir, args.qsscoredir, args.interfacedir, sample_number_per_target, outdir)
