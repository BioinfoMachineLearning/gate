...
def pair_a3m(a3m1, a3m2, outdir):
    ...
    pair_ids = Species_interact_v3.get_interactions_v2([aln_1, aln_2])

    sequences_full, sequences_monomers, pair_ids =  write_concatenated_alignment(pair_ids, [aln_1, aln_2])

    complex_alignment_file = f"{outdir}/paired.a3m"
