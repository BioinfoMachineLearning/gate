...
#SBATCH --job-name=directed_kmeans_af_v7_gcpnet_t3000_sim0.5_fold4
#SBATCH --output=directed_kmeans_af_v7_gcpnet_t3000_sim0.5_fold4-%j.out  # %j is the unique jobID
