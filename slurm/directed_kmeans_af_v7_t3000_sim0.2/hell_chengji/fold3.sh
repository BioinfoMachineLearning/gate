...
#SBATCH --job-name=directed_kmeans_af_v7_t3000_sim0.2_fold3
#SBATCH --output=directed_kmeans_af_v7_t3000_sim0.2_fold3-%j.out  # %j is the unique jobID
