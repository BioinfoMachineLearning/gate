...
#SBATCH --job-name=directed_kmeans_af_top_v8_t3000_sim0.5_fold6
#SBATCH --output=directed_kmeans_af_top_v8_t3000_sim0.5_fold6-%j.out  # %j is the unique jobID
