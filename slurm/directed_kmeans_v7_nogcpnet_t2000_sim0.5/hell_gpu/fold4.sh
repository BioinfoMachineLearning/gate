...
#SBATCH --job-name=directed_kmeans_v7_nogcpnet_t2000_sim0.5_fold4
#SBATCH --output=directed_kmeans_v7_nogcpnet_t2000_sim0.5_fold4-%j.out  # %j is the unique jobID
