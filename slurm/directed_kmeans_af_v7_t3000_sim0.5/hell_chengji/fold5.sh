...
#SBATCH --job-name=directed_kmeans_af_v7_t3000_sim0.5_fold5
#SBATCH --output=directed_kmeans_af_v7_t3000_sim0.5_fold5-%j.out  # %j is the unique jobID
