...
#SBATCH --gres gpu:1
#SBATCH --job-name=directed_kmeans_af_v7_t3000_sim0.5_fold9
#SBATCH --output=directed_kmeans_af_v7_t3000_sim0.5_fold9-%j.out  # %j is the unique jobID
