...
#SBATCH --job-name=directed_kmeans_ts_v1_t2000_sim0.2_fold6
#SBATCH --output=directed_kmeans_ts_v1_t2000_sim0.2_fold6-%j.out  # %j is the unique jobID
