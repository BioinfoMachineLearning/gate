...
if __name__ == '__main__':
    ...
    for fold in range(10):
        ...
        cmd = f"python gate/network/edge_directed_kmeans_node_pairwise_loss/train_single_fold_seed_v3_mango.py "\
            ...
            f"--project directed_kmeans_v7_t2000_sim{args.threshold} " \
            f"--dbdir experiments/ " \
            f"--labeldir dataset/CASP15_scores/label/ " \
            f"--log_val_mse true " \
            f"--fold {fold}"

        jobname = f"directed_kmeans_v7_t2000_sim{args.threshold}_fold{fold}"
