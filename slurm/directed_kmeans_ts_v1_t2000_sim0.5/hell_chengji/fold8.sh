...
#SBATCH --time 1-09:20     # days-hours:minutes time
#SBATCH --gres gpu:A100
#SBATCH --job-name=directed_kmeans_ts_v1_t2000_sim0.5_fold8
#SBATCH --output=directed_kmeans_ts_v1_t2000_sim0.5_fold8-%j.out  # %j is the unique jobID
