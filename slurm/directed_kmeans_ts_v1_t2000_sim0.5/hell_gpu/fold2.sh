...
#SBATCH --job-name=directed_kmeans_ts_v1_t2000_sim0.5_fold2
#SBATCH --output=directed_kmeans_ts_v1_t2000_sim0.5_fold2-%j.out  # %j is the unique jobID
