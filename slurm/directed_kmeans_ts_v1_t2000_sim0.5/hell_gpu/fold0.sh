...
#SBATCH --job-name=directed_kmeans_ts_v1_t2000_sim0.5_fold0
#SBATCH --output=directed_kmeans_ts_v1_t2000_sim0.5_fold0-%j.out  # %j is the unique jobID
