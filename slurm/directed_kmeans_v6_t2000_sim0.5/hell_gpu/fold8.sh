...
#SBATCH --job-name=directed_kmeans_v6_t2000_sim0.5_fold8
#SBATCH --output=directed_kmeans_v6_t2000_sim0.5_fold8-%j.out  # %j is the unique jobID
...
python gate/network/edge_directed_kmeans_node/train_single_fold_seed_v3_mango.py --datadir dataset/CASP15_scores/sample/kmeans_v6/kmeans_sil_t2000/ --scoredir dataset/CASP15_scores/ --outdir dataset/CASP15_scores/processed_dataset_directed_kmeans_v6/0.5/kmeans_sil_t2000/ --project directed_kmeans_v6_t2000_sim0.5 --dbdir experiments/ --labeldir dataset/CASP15_scores/label/ --log_val_mse true --fold 8