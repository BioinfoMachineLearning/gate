...
python gate/network/edge_directed_kmeans_node/split_fold.py --datadir dataset/CASP15_scores/sample/kmeans_v2_c2/ --scoredir dataset/CASP15_scores/ --outdir dataset/CASP15_scores/processed_dataset_directed_kmeans_v2_c3_sim/0 --sim_threshold 0
